...
if __name__ == "__main__":
    file_manager = FileManager(inbox_dir="messages/inbox/",unknown_chat_dir="messages/unknown_chat", photos_path="messages/photos",videos_path="messages/videos",audios_path="messages/audios")
